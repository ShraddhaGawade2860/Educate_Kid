        ...
        {formData ? (
          <div className="form-details">
            ...
            <p>XIIth Marksheet: <a href={`http://localhost:5000/${formData.xiithMarksheet}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
            <p>UG Certificate: <a href={`http://localhost:5000/${formData.ugCertificate}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
            <p>PG Certificate: <a href={`http://localhost:5000/${formData.pgCertificate}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
            <p>Birth Certificate: <a href={`http://localhost:5000/${formData.birthCertificate}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
            <p>Community Certificate: <a href={`http://localhost:5000/${formData.communityCertificate}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
